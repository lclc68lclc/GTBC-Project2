    ...
    app.post("/api/results_data", function(req, res) {
        if (req.body["scores"] === undefined) {
            ...
            db.glassdoor_comments.create({
                ...
                StockOptionLevel: req.body["scores"][10],
                ...
                EnvironmentSatisfaction: req.body["scores"][16],
                RelationshipSatisfaction: req.body["scores"][17],
                YearsAtCompany: req.body["scores"][18],
                YearsWithCurrManager: req.body["scores"][19],
                NumCompaniesWorked: req.body["scores"][20],
            })
            .then(function(data) {
